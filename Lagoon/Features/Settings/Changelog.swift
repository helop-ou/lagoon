    ...
    static let entries: [ChangelogEntry] = [
        ChangelogEntry(
            ...
            changes: [
                ...
                "A Baby Pink theme, for those who love pink: soft pink accents over a deep rose ground, with artwork glows blushed to match, chosen under Settings › Appearance and remembered for that Jellyfin user, so a partner's pink stays with their profile. Picking a theme blooms it across the screen.",
