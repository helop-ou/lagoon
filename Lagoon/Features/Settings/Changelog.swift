    ...
    static let entries: [ChangelogEntry] = [
        ChangelogEntry(
            ...
            changes: [
                ...
                "A Baby Pink theme, for those who love pink: soft pink accents over a deep rose ground, with artwork glows blushed to match and, on iPhone, a rose tab bar, chosen under Settings › Appearance and remembered for that Jellyfin user, so a partner's pink stays with their profile. Picking a theme blooms it across the screen.",
                "Discover's Movies, Shows and Requests buttons sit on one row on iPhone instead of stacking. A Seerr title's page now looks like a film or series page: the key art fills the top on iPhone and iPad, the Request, Open in Lagoon or status button is the page's one big button, the age rating, cast and crew are shown, and a More Like This row follows. Titles on Discover and on Seerr pages show their logo artwork where TMDB has one.",
            ]
        ),
        ChangelogEntry(
            version: "0.1",
