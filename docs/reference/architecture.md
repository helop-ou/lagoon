...
before saving a replacement token. See [HEL-141 validation](../archive/hel-141-account-privacy-validation.md).
...
The maintained touch/remote input and PiP ownership contract is in
[Playback](../playback.md#controls-and-presentation). Simulator evidence and
remaining physical acceptance are in the [touch validation record](../archive/hel-153-touch-validation.md).
