...
Archived planning record. Dates and decisions below apply to the recorded work;
the maintained site lives in the separate `lagoon-website` repository and the
current publication tasks are in the [release guide](../../release.md#website).
...
| `/licenses` | Third-party acknowledgements and license texts, with links to the exact source/build/relink materials required for the distributed version. | [Native inventory](../../reference/native-dependency-inventory.json) and the licensing assessment in HEL-143; recipient materials remain unfinished. |
...
These items are part of the wider [public release checklist](../../release.md#public-release).
