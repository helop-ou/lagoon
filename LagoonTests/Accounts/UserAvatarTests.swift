...
struct UserAvatarTests {
    ...
    @Test func aUserWithoutAPictureHasNoURL() {
        ...
        let account = StoredAccount(serverURL: server, serverName: nil, userId: "93f3", userName: "Alex")
    ...
    @Test func anAccountBuildsItsAvatarAtItsOwnServer() throws {
        let account = StoredAccount(
            ...
            serverName: nil, userId: "93f3", userName: "Alex", primaryImageTag: "73c5"
        )
    ...
    @Test func accountsStoredBeforeTheTagStillDecode() throws {
        let stored = Data(#"""
        [{"serverURL":"https://media.test/jellyfin","serverName":"Fixture Server","userId":"93f3","userName":"Alex"}]
        """#.utf8)
