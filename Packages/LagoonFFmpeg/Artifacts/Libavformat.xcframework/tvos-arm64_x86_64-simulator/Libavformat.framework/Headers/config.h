...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=x86_64 --enable-cross-compile --cc=clang --cxx=clang++ --host-cc=clang --host-ld=clang --enable-static --disable-shared --enable-pic --enable-version3 --disable-autodetect --disable-programs --disable-doc --disable-debug --disable-avdevice --disable-avfilter --disable-filters --disable-devices --disable-bzlib --disable-iconv --disable-xlib --disable-x86asm --enable-network --enable-protocols --enable-gnutls --enable-gmp --enable-libxml2 --enable-zlib --enable-videotoolbox --enable-audiotoolbox --pkg-config-flags=--static --extra-cflags='-target x86_64-apple-tvos26.0-simulator -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/AppleTVSimulator.platform/Developer/SDKs/AppleTVSimulator26.5.sdk -I/private/tmp/lagoon-hel142-build/build-tvos-simulator-x86_64/deps/include' --extra-ldflags='-target x86_64-apple-tvos26.0-simulator -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/AppleTVSimulator.platform/Developer/SDKs/AppleTVSimulator26.5.sdk -L/private/tmp/lagoon-hel142-build/build-tvos-simulator-x86_64/deps/lib -framework Security -framework CoreFoundation' --disable-muxers --enable-muxer=flac --enable-muxer=dash --enable-muxer=hevc --enable-muxer=m4v --enable-muxer=matroska --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=mpegts --enable-muxer='webm*' --disable-encoders --enable-encoder=aac --enable-encoder=alac --enable-encoder=flac --enable-encoder='pcm*' --enable-encoder=movtext --enable-encoder=mpeg4 --enable-encoder=h264_videotoolbox --enable-encoder=hevc_videotoolbox --enable-encoder=prores --enable-encoder=prores_videotoolbox --disable-demuxers --enable-demuxer=aac --enable-demuxer=ac3 --enable-demuxer=aiff --enable-demuxer=amr --enable-demuxer=ape --enable-demuxer=asf --enable-demuxer=ass --enable-demuxer=av1 --enable-demuxer=avi --enable-demuxer=caf --enable-demuxer=concat --enable-demuxer=dash --enable-demuxer=data --enable-demuxer=dv --enable-demuxer=eac3 --enable-demuxer=flac --enable-demuxer=flv --enable-demuxer=h264 --enable-demuxer=hevc --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=loas --enable-demuxer=m4v --enable-demuxer=matroska --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer='mpeg*' --enable-demuxer=ogg --enable-demuxer=rm --enable-demuxer=rtsp --enable-demuxer=rtp --enable-demuxer=srt --enable-demuxer=webvtt --enable-demuxer=vc1 --enable-demuxer=wav --enable-demuxer=webm_dash_manifest --disable-decoders --enable-decoder=av1 --enable-decoder=dca --enable-decoder=dxv --enable-decoder=ffv1 --enable-decoder=ffvhuff --enable-decoder=flv --enable-decoder=h263 --enable-decoder=h263i --enable-decoder=h263p --enable-decoder=h264 --enable-decoder=hap --enable-decoder=hevc --enable-decoder=huffyuv --enable-decoder=indeo5 --enable-decoder=mjpeg --enable-decoder=mjpegb --enable-decoder='mpeg*' --enable-decoder=mts2 --enable-decoder=prores --enable-decoder=mpeg4 --enable-decoder=mpegvideo --enable-decoder=rv10 --enable-decoder=rv20 --enable-decoder=rv30 --enable-decoder=rv40 --enable-decoder=snow --enable-decoder=svq3 --enable-decoder=tscc --enable-decoder=txd --enable-decoder=wmv1 --enable-decoder=wmv2 --enable-decoder=wmv3 --enable-decoder=vc1 --enable-decoder=vp6 --enable-decoder=vp6a --enable-decoder=vp6f --enable-decoder=vp7 --enable-decoder=vp8 --enable-decoder=vp9 --enable-decoder='aac*' --enable-decoder='ac3*' --enable-decoder='adpcm*' --enable-decoder='alac*' --enable-decoder='amr*' --enable-decoder=ape --enable-decoder=cook --enable-decoder=dca --enable-decoder=dolby_e --enable-decoder='eac3*' --enable-decoder=flac --enable-decoder='mp1*' --enable-decoder='mp2*' --enable-decoder='mp3*' --enable-decoder=opus --enable-decoder='pcm*' --enable-decoder=sonic --enable-decoder=truehd --enable-decoder=tta --enable-decoder=vorbis --enable-decoder='wma*' --enable-decoder=ass --enable-decoder=ccaption --enable-decoder=dvbsub --enable-decoder=dvdsub --enable-decoder=mpl2 --enable-decoder=movtext --enable-decoder=pgssub --enable-decoder=srt --enable-decoder=ssa --enable-decoder=subrip --enable-decoder=xsub --enable-decoder=webvtt"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "Apple clang version 21.0.0 (clang-2100.1.1.101)"
